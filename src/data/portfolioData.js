...
//     bio: "Dynamic Flutter Developer with over 4 years of experience building cross-platform mobile apps, and strong backend skills in Node.js and Clean Architecture. Passionate about creating user-friendly, scalable applications that solve real-world problems.",
...
//       description: "A community-driven, offline-first neighborhood directory connecting residents with local businesses, services, and duty pharmacies, featuring zero-latency UI powered by Hive local caching and Smart Delta-Sync with Supabase.",
//       technologies: ["Flutter (Clean Architecture, BLoC/Cubit)", "Hive (NoSQL)", "Supabase", "Firebase FCM", "OpenStreetMap"],
...
//       description: "A smart bus ticket booking platform enabling passengers to search for intercity trips in real-time, select seats via an interactive seat map, and receive digital QR boarding passes with instant booking confirmations.",
//       technologies: ["Flutter (Clean Architecture, BLoC, Dio, GoRouter)", "Firebase FCM", "Secure Storage"],
...
//       description: "A comprehensive transport operations ERP system with 23+ feature modules, enabling transport companies to manage offices, fleets, drivers, routes, trips, and pricing through a centralized admin dashboard.",
//       technologies: ["Flutter (Clean Architecture, BLoC, Dio, GoRouter)", "QR Code Scanner", "Bluetooth Thermal Printer", "PDF Generation"],
...
//       description: "A professional bilingual corporate website for ATMTA Technological Solutions, directed and managed using AI-augmented development workflows. Features seamless RTL/LTR transitions, animated pages, and optimized performance.",
//       technologies: ["Next.js", "React 19", "TypeScript", "Tailwind CSS v4", "Framer Motion", "AI-Driven Development"],
...
//       description: "Developed two Flutter-based transport platforms (Musafer & Masar), directed the company's official website creation using AI-driven development, and led client acquisition by pitching directly to transport companies."
//     },
//     {
